  ...
  return (
    <div className="container mx-auto">
      <div className="min-h-screen flex flex-col justify-center items-center py-16">
        <div className="flex flex-col-reverse md:flex-row items-center justify-center flex-grow gap-4 text-center md:text-left md:justify-between">
          <div className="md:w-1/2">
            <div className="text-6xl font-bold">My name is STORM.</div>
            <div className="mt-6 text-4xl">
              I want to be a more perfect developer. Also, I'm a backend
              developer and student.
            </div>
          </div>
          <div>
            <img
              src="https://github.com/uniquedevstorm.png"
              alt=""
              draggable="false"
        ...
        <div className="w-full flex items-center">
          <div className="flex flex-grow gap-8">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=100010888537979"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a
              href="https://twitter.com/D_evStorm"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a
              href="https://www.instagram.com/d_evstorm/"
              target="_blank"
              rel="noreferrer"
            >
              <svg
          ...
          <a className="text-lg" href="mailto:me@devstorm.kr">
            me@devstorm.kr
          </a>
        </div>
      </div>
